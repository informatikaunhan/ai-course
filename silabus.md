...
| Komponen | Keterangan |
|----------|------------|
| **Nama Mata Kuliah** | Kecerdasan Artifisial (Artificial Intelligence) |
| **Kode Mata Kuliah** | AI401 |
...
|----------|-------------|------------------|
| **Teori (3 SKS)** | 3 × 50 menit | 150 menit |
| **Tatap Muka Total** | | **150 menit/minggu** |
| **Belajar Mandiri** | 3 × (2 × 60 menit) | 360 menit/minggu |

---

## DESKRIPSI MATA KULIAH

Mata kuliah Kecerdasan Artifisial merupakan mata kuliah wajib yang memperkenalkan mahasiswa pada prinsip-prinsip dasar, teknik, dan aplikasi kecerdasan artifisial. Mata kuliah ini membangun pemahaman tentang bagaimana sistem komputasi dapat meniru kemampuan kognitif manusia seperti penalaran, pembelajaran, dan pengambilan keputusan.

Mahasiswa akan mempelajari konsep agen cerdas, berbagai algoritma pencarian (uninformed dan informed search), pencarian adversarial untuk game, constraint satisfaction problems, representasi pengetahuan menggunakan logika, penalaran dengan ketidakpastian menggunakan probabilitas dan jaringan Bayesian, serta dasar-dasar pembelajaran mesin.

Mata kuliah ini memanfaatkan fondasi dari **Struktur Data dan Algoritma (Semester 2)** untuk implementasi algoritma pencarian dan struktur data seperti tree, graph, dan priority queue, serta **Statistika dan Probabilitas (Semester 3)** untuk memahami penalaran probabilistik dan pembelajaran mesin. Penguasaan materi ini menjadi fondasi untuk mata kuliah lanjutan yaitu **Machine Learning (Semester 5)** yang akan memperdalam teknik pembelajaran mesin secara komprehensif.
...
4. **Analisis Algoritma**: Notasi Big-O, kompleksitas waktu dan ruang
5. **Rekursi dan Divide-and-Conquer**: Teknik pemecahan masalah rekursif
...
4. **Statistika Deskriptif dan Inferensial**: Mean, variance, estimasi parameter
...
| **CPL-5** | Mampu mengidentifikasi implikasi etis dan sosial dari teknologi informasi |
...
|------|----------------------------------|-------------|
| **CPMK-1** | Mampu menjelaskan konsep dasar kecerdasan artifisial, paradigma agen cerdas, dan karakteristik lingkungan tugas | CPL-1 |
| **CPMK-2** | Mampu menganalisis dan mengimplementasikan algoritma pencarian uninformed dan informed untuk pemecahan masalah | CPL-2, CPL-3 |
| **CPMK-3** | Mampu menerapkan algoritma pencarian adversarial dan teknik constraint satisfaction untuk penyelesaian masalah kompleks | CPL-2, CPL-3 |
| **CPMK-4** | Mampu merepresentasikan pengetahuan menggunakan logika proposisional dan logika predikat serta melakukan inferensi | CPL-1, CPL-2 |
| **CPMK-5** | Mampu menganalisis dan menerapkan penalaran probabilistik menggunakan teori probabilitas dan jaringan Bayesian | CPL-2, CPL-4 |
| **CPMK-6** | Mampu menjelaskan dan menerapkan konsep dasar pembelajaran mesin termasuk pembelajaran terawasi dan tak terawasi | CPL-2, CPL-3, CPL-4 |
| **CPMK-7** | Mampu mengidentifikasi dan mengevaluasi aspek etika, keamanan, dan dampak sosial dari sistem kecerdasan artifisial | CPL-1, CPL-5 |
...
|------|--------------------------------------|------|
| **Sub-CPMK-1.1** | Mampu menjelaskan definisi, sejarah, dan cabang-cabang kecerdasan artifisial | CPMK-1 |
...
| **Sub-CPMK-4.2** | Mampu merepresentasikan pengetahuan menggunakan logika predikat (first-order logic) dan menerapkan unifikasi | CPMK-4 |
| **Sub-CPMK-5.1** | Mampu menerapkan teori probabilitas dan Teorema Bayes untuk penalaran dengan ketidakpastian | CPMK-5 |
| **Sub-CPMK-5.2** | Mampu membangun dan melakukan inferensi pada jaringan Bayesian sederhana | CPMK-5 |
| **Sub-CPMK-6.1** | Mampu menjelaskan dan menerapkan algoritma pembelajaran terawasi (decision tree, naive Bayes, regresi) | CPMK-6 |
| **Sub-CPMK-6.2** | Mampu menjelaskan konsep pembelajaran tak terawasi dan reinforcement learning | CPMK-6 |
| **Sub-CPMK-7.1** | Mampu mengidentifikasi isu etika dan keamanan dalam pengembangan sistem AI | CPMK-7 |
| **Sub-CPMK-7.2** | Mampu mengevaluasi dampak sosial dan masa depan AI dalam konteks pertahanan dan masyarakat | CPMK-7 |
...
### PERTEMUAN 1: Pengantar Kecerdasan Artifisial dan Agen Cerdas

| Komponen | Uraian |
|----------|--------|
| **Sub-CPMK** | Sub-CPMK-1.1, Sub-CPMK-1.2 |
| **Indikator Pencapaian** | (1) Mahasiswa mampu menjelaskan definisi dan sejarah perkembangan AI; (2) Mahasiswa mampu mengidentifikasi dan mengklasifikasikan jenis-jenis agen cerdas; (3) Mahasiswa mampu menganalisis lingkungan tugas menggunakan kerangka PEAS |
| **Materi Pembelajaran** | Definisi dan ruang lingkup AI; Sejarah AI: dari Turing hingga era modern; Empat pendekatan AI: thinking humanly, thinking rationally, acting humanly, acting rationally; Konsep agen dan lingkungan; Jenis-jenis agen: simple reflex, model-based reflex, goal-based, utility-based, learning agent; Karakteristik lingkungan tugas: observable, deterministic, episodic, static, discrete, single/multi-agent; Kerangka PEAS (Performance, Environment, Actuators, Sensors) |
| **Bentuk & Waktu Pembelajaran** | Teori: 3×50 menit (150 menit) |
| **Metode Pembelajaran** | Ceramah interaktif, diskusi, studi kasus |
| **Pengalaman Belajar** | Mahasiswa menganalisis berbagai sistem AI nyata menggunakan kerangka PEAS dan mengidentifikasi jenis agennya |
...
### PERTEMUAN 2: Pemecahan Masalah dengan Pencarian - Uninformed Search
...
### PERTEMUAN 3: Pencarian Heuristik - Informed Search
...
| **Pengalaman Belajar** | Mahasiswa merancang fungsi heuristik untuk 8-puzzle dan menganalisis performa A* dengan berbagai heuristik |
...
### PERTEMUAN 4: Pencarian Lokal dan Optimisasi
...
### PERTEMUAN 5: Pencarian Adversarial - Game Playing
...
### PERTEMUAN 6: Constraint Satisfaction Problems (CSP)
...
| **Bentuk & Waktu Pembelajaran** | Teori: 3×50 menit (150 menit) |
| **Metode Pembelajaran** | Ceramah, demonstrasi, problem-based learning |
| **Pengalaman Belajar** | Mahasiswa memformulasikan dan menyelesaikan Sudoku dan map coloring sebagai CSP |
...
### PERTEMUAN 7: Review dan Latihan Komprehensif (Pertemuan 1-6)
...
| Komponen | Uraian |
|----------|--------|
| **Cakupan Materi** | Pertemuan 1-6: Pengantar AI, Agen Cerdas, Uninformed Search, Informed Search, Pencarian Lokal, Game Playing, CSP |
| **Bentuk Ujian** | Ujian Tertulis |
...
### PERTEMUAN 9: Representasi Pengetahuan - Logika Proposisional

| Komponen | Uraian |
|----------|--------|
| **Sub-CPMK** | Sub-CPMK-4.1 |
| **Indikator Pencapaian** | (1) Mahasiswa mampu merepresentasikan pengetahuan dalam logika proposisional; (2) Mahasiswa mampu melakukan inferensi menggunakan aturan inferensi dasar; (3) Mahasiswa mampu membuktikan entailment menggunakan resolution |
| **Materi Pembelajaran** | Kebutuhan representasi pengetahuan formal; Sintaks dan semantik logika proposisional; Konnektif logika: NOT, AND, OR, IMPLIES, IFF; Tabel kebenaran dan model; Entailment dan satisfiability; Aturan inferensi: Modus Ponens, Modus Tollens, And-Elimination, etc.; Konjungtif Normal Form (CNF); Algoritma resolution untuk pembuktian; Knowledge base dan inference engine |
| **Bentuk & Waktu Pembelajaran** | Teori: 3×50 menit (150 menit) |
| **Metode Pembelajaran** | Ceramah, latihan pembuktian, demonstrasi |
| **Pengalaman Belajar** | Mahasiswa merepresentasikan puzzle logika (seperti Wumpus World) dan melakukan inferensi |
...
### PERTEMUAN 10: Representasi Pengetahuan - Logika Predikat (First-Order Logic)

| Komponen | Uraian |
|----------|--------|
| **Sub-CPMK** | Sub-CPMK-4.2 |
| **Indikator Pencapaian** | (1) Mahasiswa mampu merepresentasikan pengetahuan dalam logika predikat; (2) Mahasiswa mampu melakukan unifikasi dan substitusi; (3) Mahasiswa mampu menerapkan forward dan backward chaining |
| **Materi Pembelajaran** | Keterbatasan logika proposisional; Sintaks FOL: konstanta, variabel, predikat, fungsi, kuantor; Kuantor universal (∀) dan eksistensial (∃); Semantik FOL: interpretasi dan model; Proses unifikasi dan Most General Unifier (MGU); Forward chaining: data-driven reasoning; Backward chaining: goal-driven reasoning; Resolution dalam FOL; Aplikasi: expert systems, knowledge graphs |
| **Bentuk & Waktu Pembelajaran** | Teori: 3×50 menit (150 menit) |
| **Metode Pembelajaran** | Ceramah, latihan representasi, demonstrasi inferensi |
| **Pengalaman Belajar** | Mahasiswa merepresentasikan domain pengetahuan dalam FOL dan melakukan query menggunakan backward chaining |
...
| **Indikator Pencapaian** | (1) Mahasiswa mampu menjelaskan sumber ketidakpastian dalam AI; (2) Mahasiswa mampu menerapkan probabilitas bersyarat dan Teorema Bayes; (3) Mahasiswa mampu melakukan inferensi probabilistik sederhana |
| **Materi Pembelajaran** | Sumber ketidakpastian: laziness dan ignorance; Keterbatasan logika untuk ketidakpastian; Review probabilitas: probabilitas prior, joint probability; Probabilitas bersyarat dan aturan produk; Teorema Bayes: P(H|E) = P(E|H)P(H)/P(E); Normalisasi; Independensi dan independensi bersyarat; Naive Bayes sebagai model probabilistik; Contoh aplikasi: diagnosis medis, spam filtering |
| **Bentuk & Waktu Pembelajaran** | Teori: 3×50 menit (150 menit) |
| **Metode Pembelajaran** | Ceramah, latihan perhitungan, studi kasus |
| **Pengalaman Belajar** | Mahasiswa menghitung probabilitas posterior untuk kasus diagnosis dan klasifikasi sederhana |
...
| **Indikator Pencapaian** | (1) Mahasiswa mampu membangun jaringan Bayesian dari deskripsi masalah; (2) Mahasiswa mampu menghitung probabilitas menggunakan struktur jaringan; (3) Mahasiswa mampu melakukan inferensi pada jaringan Bayesian sederhana |
| **Materi Pembelajaran** | Motivasi jaringan Bayesian: representasi compact; Struktur jaringan Bayesian: DAG dan CPT; Semantik jaringan Bayesian: joint distribution; Membangun jaringan Bayesian: topologi kausal; Conditional independence dari struktur graf; Inferensi eksak: enumeration, variable elimination; D-separation; Contoh: alarm network, medical diagnosis network; Pengenalan approximate inference |
| **Bentuk & Waktu Pembelajaran** | Teori: 3×50 menit (150 menit) |
| **Metode Pembelajaran** | Ceramah, demonstrasi, latihan konstruksi jaringan |
| **Pengalaman Belajar** | Mahasiswa membangun jaringan Bayesian untuk skenario nyata dan menghitung probabilitas query |
...
### PERTEMUAN 14: Pembelajaran Mesin - Unsupervised Learning dan Reinforcement Learning
...
| **Indikator Pencapaian** | (1) Mahasiswa mampu mengidentifikasi isu etika dalam pengembangan AI; (2) Mahasiswa mampu menganalisis dampak sosial AI; (3) Mahasiswa mampu mengintegrasikan seluruh materi yang telah dipelajari |
| **Materi Pembelajaran** | Isu etika AI: bias algoritmik, fairness, transparency, accountability; AI safety: alignment problem, existential risk; Privasi dan surveillance; AI dalam konteks pertahanan: autonomous weapons, surveillance systems; Regulasi AI: EU AI Act, AUKUS, kebijakan nasional; Masa depan AI: AGI, technological unemployment; Review komprehensif seluruh materi; Latihan soal UAS; Diskusi dan tanya jawab |
| **Bentuk & Waktu Pembelajaran** | Teori: 3×50 menit (150 menit) |
| **Metode Pembelajaran** | Diskusi, debate, studi kasus, review |
| **Pengalaman Belajar** | Mahasiswa menganalisis studi kasus etika AI dan mempresentasikan pandangannya |
...
|----------|:-----:|------------|
| Tugas Individu | 30% | Tugas mingguan dan analisis |
| Kuis | 10% | Kuis di beberapa pertemuan |
| Essay/Diskusi | 5% | Partisipasi dan essay etika AI |
| Ujian Tengah Semester (UTS) | 25% | Teori (Pertemuan 1-6) |
| Ujian Akhir Semester (UAS) | 30% | Teori (Pertemuan 1-15, penekanan 9-15) |
| **Total** | **100%** | |
...
|-------|:-----:|----------|
| Pemahaman Konsep | 40% | Ketepatan penjelasan konsep dan teori |
| Penyelesaian Masalah | 30% | Kemampuan menerapkan algoritma dan teknik yang tepat |
| Analisis | 20% | Kemampuan menganalisis kompleksitas dan trade-off |
...
4. **Kuis**: Tidak ada kuis susulan kecuali dengan alasan yang sah
5. **Ujian Susulan**: Hanya diberikan dengan alasan yang sah dan bukti pendukung
6. **Perangkat Elektronik**: Kalkulator diperbolehkan pada ujian tertentu, laptop/handphone tidak diperbolehkan
...
- Simulasi dan game theory untuk strategi
